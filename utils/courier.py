...
# --------------------------------------
def add_courier(insert_courier_into_db=insert_courier_into_db, read_couriers=read_couriers):
    courier_name = input('enter courier name: ')
    insert_courier_into_db(courier_name)
    return read_couriers()


def update_courier(couriers_list, update_courier_on_db=update_courier_on_db, read_couriers=read_couriers):
    try:
...
def delete_courier(couriers_list, delete_courier_from_db=delete_courier_from_db, read_couriers=read_couriers):
    try:
