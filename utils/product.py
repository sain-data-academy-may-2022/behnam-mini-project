...
# ---------------------------------------
def add_product(insert_product_into_db=insert_product_into_db, read_products=read_products):
    product_name = input('enter product name: ')
    insert_product_into_db(product_name)
    return read_products()


def update_product(products_list, update_product_on_db=update_product_on_db, read_products=read_products):
    try:
...
def delete_product(products_list, delete_product_from_db=delete_product_from_db, read_products=read_products):
    try:
